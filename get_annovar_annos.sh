...
for chr in {1..22} M X Y; do wget -P humandb/ http://hgdownload.cse.ucsc.edu/goldenPath/hg19/chromosomes/chr${chr}.fa.gz; done
for chr in {1..22} M X Y; do gunzip humandb/chr${chr}.fa.gz; done
perl retrieve_seq_from_fasta.pl -format genericGene -seqdir humandb/ hg19_wgEncodeGencodeBasicV19.txt --outfile hg19_wgEncodeGencodeBasicV19Mrna.fa
